...
<section class="bg-base-200">
  <div class="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    <p class="mt-2 text-base-content/60">Define zones where you want to receive jobs.</p>
        ...
        <tbody>
          @forelse($areas as $area)
            <tr>
              ...
              <td>
                <span class="badge {{ $area->is_active ? 'badge-success' : 'badge-ghost' }}">{{ $area->is_active ? 'Active' : 'Inactive' }}</span>
              </td>
              <td class="text-right">
          ...
          @empty
            <tr><td colspan="4" class="text-base-content/50">No service areas added yet.</td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
